...
from common.kubernetes_pod_utility import watch_pod_status, get_pod_logs, get_pod_logs_since_seconds
...
def check_kubernetes_configuration_state(kc_client, resource_group, cluster_rp, cluster_type, cluster_name, configuration_name,
    ...
    while True:
        ...
        if (compliance_state == 'Failed' or compliance_state.lower() == 'non-compliant'):
